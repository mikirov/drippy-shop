...
export class NavService {
	...
	MENUITEMS: Menu[] = [
		...
		// {
		// 	title: 'Products', type: 'link', active: false, path: '/shop/product/three/column/trim-dress'
		// },
		// {
			...
			title: 'clothing', type: 'sub', megaMenu: true, active: false, children: [
			  {
				  title: 'mens fashion',  type: 'link', active: false, children: [
					  ...
					  { path: '/home/fashion', title: 'T-shirts',  type: 'link' },
					  { path: '/home/fashion', title: 'pants',  type: 'link' },
					  { path: '/home/fashion', title: 'shirts',  type: 'link' },
					  { path: '/home/fashion', title: 'jackets',  type: 'link' },
			  ...
			  },
			  {
				  title: 'women fashion',  type: 'link', active: false, children: [
					  ...
					  { path: '/home/fashion', title: 'pants',  type: 'link' },
					  { path: '/home/fashion', title: 'jackets',  type: 'link' },
					  { path: '/home/fashion', title: 'tops',  type: 'link' },
					  { path: '/home/fashion', title: 't-shirts',  type: 'link' },
