...
export const environment = {
  ...
  SHIPPMENT_CALC_URL : 'https://delivery.econt.com/customer_info.php', // URL визуализиращ форма за доставка
  SHOP_CURRENCY : 'BGN', // валута на магазина (валута на Наложен платеж)
  UPDATE_ORDER_ENDPOINT : 'https://delivery.econt.com/services/OrdersService.updateOrder.json', // Ендпойнта на услугата създаване или редактиране на поръчка
